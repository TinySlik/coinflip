...
GAME_CELL_COMPELETE_THREE = "GAME_CELL_COMPELETE_THREE"
GAME_CELL_COMPELETE_FOUR_H = "GAME_CELL_COMPELETE_FOUR_H"
GAME_CELL_COMPELETE_FOUR_V = "GAME_CELL_COMPELETE_FOUR_V"
GAME_CELL_COMPELETE_FIVE = "GAME_CELL_COMPELETE_FIVE"
GAME_CELL_COMPELETE_T = "GAME_CELL_COMPELETE_T"
